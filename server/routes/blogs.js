  ...
  router.get('/getUser', (req, res) => {
      User.find(function (err, person) {
         if (err) {
          ...
          res.json({ code:200 , success: true, data: person }); 
         }  
     })
  })
...
//get single user
   router.post('/getSingleUser', (req, res) => {
      User.findOne({ _id: req.body.id },function (err, user) {
         if (err) {
          ...
          res.json({ code:200 , success: true, data: user }); 
         }  
     })
  })
  ...
  //update single user
   router.post('/updateSingleUser', (req, res) => {
             ...
             if(user){
                  ...
                  model.save(function(err, userData) {
                      if (err) {
                          ...
                          res.json({ code:200 , success: true, data: userData });
                       }
                    }) 
                }     
             }  
     ...
     //delete single user
   router.post('/deleteSingleUser', (req, res) => {
