...
getAlluser(){
 ...
 return this.http.get(this.domain + 'blogs/getUser', this.options).map(res => res.json());
}
...
getSingleuser(id){
 ...
 this.createAuthenticationHeaders(); 
 return this.http.post(this.domain + 'blogs/getSingleUser',userData, this.options).map(res => res.json());
}

updateSingleuser(user){
 this.createAuthenticationHeaders(); 
   return this.http.post(this.domain + 'blogs/updateSingleUser',user, this.options).map(res => res.json());
}
deleteSingleuser(id){
  const userData = {
      id: id  
 ...
 this.createAuthenticationHeaders(); 
   return this.http.post(this.domain + 'blogs/deleteSingleUser',userData, this.options).map(res => res.json());
}
